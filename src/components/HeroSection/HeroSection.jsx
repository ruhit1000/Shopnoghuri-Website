    ...
    return (
        <div className='pt-20 md:pt-30 lg:pt-35.5 pb-25'>
            ...
            <form className='mt-20 md:mt-30 lg:mt-42.5 font-rubik bg-base-100 mx-auto md:mx-0 rounded-2xl md:rounded-s-none w-[95%] md:w-[80%] max-w-7xl pt-10 md:pt-0 md:flex justify-between' action="">
                ...
                <div>
                    <button
                        className='group font-playfair-display bg-[#FF7757] w-full text-4xl md:text-3xl text-base-100 py-10 md:py-6 px-5 mt-14 md:mt-0 md:h-full flex items-center justify-center gap-8 pl-10 rounded-b-2xl md:rounded-s-none md:rounded-e-2xl cursor-pointer transition-all duration-300 hover:brightness-110 hover:shadow-xl active:scale-[0.98]'
                        onClick={onsubmit}
                    >
                        Book Now
                        <span className='pt-3 transition-transform duration-300 group-hover:translate-x-2'>
                            <FaArrowRight />
                        </span>
                    </button>
                </div>
